...
export const login = (credential, asHost) => {
    ...
    body: JSON.stringify(credential), //change the obj to string
  }).then((response) => {
...
export const getReservations = () => {
    //get the value by key in local storage
  ...
  export const getStaysByHost = () => {
   ...
   // the parameters for this API are stored in URL
  ...
  export const getReservationsByStay = (stayId) => {
   ...
   //notice: this api also need to upload files
