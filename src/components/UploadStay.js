...
class UploadStay extends React.Component {
  ...
  handleSubmit = async (values) => {
    ...
    const { files } = this.fileInputRef.current;//used to read the data
 
    if (files.length > 5) {
      message.error("You can upload up most 5 pictures.");
      return;
    }
...
//input component => used to interact with users to upload files